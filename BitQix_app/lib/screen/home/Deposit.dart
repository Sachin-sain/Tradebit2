...
void onSearchTextChanged(String text) {
  ...
  setState(() {
    ...
    for (int j = 0; j <
        allCurrenciesDatasearch.length; j++) {
      if (allCurrenciesDatasearch[j]['name'].contains(
          text.toUpperCase())) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Deposit",style: TextStyle(fontFamily: "IBM Plex Sans")),
      ),
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            Navigator.of(context).push(PageRouteBuilder(
                                pageBuilder: (_, __, ___) => new  DepositDetail(network: allCurrenciesData[i]['currency_networks'],name: allCurrenciesData[i]['name'],)));
                          },
                          child: Row(
