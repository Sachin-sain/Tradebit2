...
class _DepositDetailState extends State<DepositDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar( backgroundColor: Color(0xff17394f),
        title: Text("Deposit ${widget.name}"),),
      body: Padding(
    ...
    return  Padding(
      ...
      child: Column(
        children: [
          ...
          Text('''● Send Only Using The ${widget.network[i]['token_type'].toString()} Network. Using Any Other Network Will Result In Loss Of Funds.''',style: TextStyle(color: day==false?Colors.white:Colors.white,fontFamily: "IBM Plex Sans",fontSize: 10.0)),
          Text('''● Deposit Only ${widget.name} To This Deposit Address. Depositing Any Other Asset Will Result In A Loss Of Funds.''',style: TextStyle(color: day==false?Colors.white:Colors.white,fontFamily: "IBM Plex Sans",fontSize: 10.0))
