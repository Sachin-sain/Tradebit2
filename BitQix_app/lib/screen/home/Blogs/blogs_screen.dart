...
class _BlogsScreenState extends State<BlogsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Blogs",style: TextStyle(fontFamily: "IBM Plex Sans" ),),
                                    ...
                                    child: Text(
                                      ...
                                      style: selectedIndex == i
                                          ...
                                          : TextStyle(
                                              ...
                                              color: day == false
                                                  ? Colors.white54
                                                  : Colors.black54,fontFamily: "IBM Plex Sans"
                                            ),
                                    ),
                                  ),
                                )
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ElevatedButton(
                                          ...
                                          child: Text('Read More',style: TextStyle(fontFamily: "IBM Plex Sans"),)),
                                      SizedBox(
                                        width: width * 0.02,
                                      ),
                                      Icon(
                                      ...
                                      Text(DateFormat.yMMMMd().format(
                                          DateTime.parse(
                                              blogsList[i]['updatedAt'])),style: TextStyle(fontFamily: "IBM Plex Sans"),)
                                    ],
                                  ),
                                  Divider(
                                    color: day ? Colors.black : Colors.white,
