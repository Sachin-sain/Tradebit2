...
class _ContactusState extends State<Contactus> {
      ...
      if (data["status_code"] == '1') {
       setState(() {
         ...
         for(int i =0;i<categories.length;i++){
           Categoryies.add(new Category(name: categories[i]['name'],id: categories[i]['id'].toString()));}
       });
  ...
  Widget build(BuildContext context) {
    ...
    return  Form(
      key: _formKeys,
      child: Scaffold(
        appBar: AppBar(title: Text("Contact Us",style: TextStyle(fontFamily: "IBM Plex Sans")),backgroundColor: Color(0xff17394f),),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 15,),
                  Text("Choose Category",textAlign: TextAlign.center, style: TextStyle(
                    ...
                    child: DropdownButtonFormField<Category>(
                      ...
                      items: Categoryies.map((Category value) {
                        return DropdownMenuItem<Category>(
                          value: value,
                          child: Text(value.name,style: TextStyle(color: day==false?Colors.white:Colors.black, fontFamily: "IBM Plex Sans",),
                          ),
                        );
                      }).toList(),
                      onChanged: (newVal) {
...
setState(() {
  ...
  createticket();
                    ...
                    child: Container(alignment: Alignment.center,
                      ...
                      child: submitdata==true? CircularProgressIndicator(): Text('Submit',textAlign: TextAlign.center, style: TextStyle(
