...
Future<void> notification(String value) async {
  ...
  if(data["status_code"]=='1'){
      data["data"]["notifications"]==null?notificationdata.clear():notificationdata=data["data"]["notifications"];
...
int page=1;
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      ...
      key :_formKeys,
      child: Scaffold(
      appBar: AppBar(title: Text("Notification",style: TextStyle(fontFamily: "IBM Plex Sans")),backgroundColor: Color(0xff17394f),),
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
                children: <Widget>[
                  ...
                  Container(
      child: notificationdata.length>0? ListView.builder(
          shrinkWrap: true,
          primary: false,
      ...
      ):Container(child:Center(child: Text("No Data",style: TextStyle(color:day==false?Colors.white:Colors.black ),))), )
    ...
    return   Column(
      children: [
        SingleChildScrollView(
          ...
          child: Container(
            color: notificationdata[0]["read_status"]=="notreaded"?Color(0xff17394f).withOpacity(0.5):Colors.transparent,
            padding: EdgeInsets.all(15),
            child: SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
                children: [
                  Icon(Icons.notifications,color:  day==false?Colors.white:Color(0xff17394f)),
                  SizedBox(width: 5,),
                  Column(
                    children: [
                      Container(
                        width:MediaQuery.of(context).size.width,
                          child:Html(data:notificationdata[i]["content"] ,defaultTextStyle:TextStyle(fontSize: 12,color: day==false?Colors.white:Color(0xff17394f),fontWeight:notificationdata[0]["read_status"]=="notreaded"? FontWeight.bold:FontWeight.normal) ,)
...
color: day==false?Colors.white:Color(0xff17394f),
                        width:MediaQuery.of(context).size.width * 0.18,
                         child: Padding(
                           ...
                           child: Text(notificationdata[0]["read_status"]=="notreaded"?"Not Read":"Read",style: TextStyle(color:day==false?Color(0xff17394f):Colors.white )),
                         ),
                       ),
                     ),
        ...
        Row(
          ...
          children: [
            Container(
              ...
              width: MediaQuery.of(context).size.width * 0.20,
              child: Text("Created at",style: TextStyle(fontSize: 12),),
            ),
          ],
        ),
