...
class _VerifyKYCState extends State<VerifyKYC> {
 // String status;
  ...
  // identity_front_path: (binary)
  // identity_back_path: (binary)
  // pan_card_path: (binary)
  // first_name: Shweta
  // middle_name:
  // last_name: Syal
  ...
  // identity_number: gffff472547
  // pan_card_number: yhj41741uy
  void updatekyc() async {
    final uri =
    new Uri.https(APIClasses.LBM_BaseURL, APIClasses.kycupdate);
   ...
   // print(request.files.first);
    ...
    if (response.statusCode == 200) {
      ...
      print("done");
      ToastShowClass.toastShow(context, 'KYC Submitted Successfully', Colors.blue);
      setState(() {
        enable=true;
      });
  ...
  return Form(
    ...
    child: Scaffold(
        ...
        body: Verifiedstatus == "new"||Verifiedstatus == "rejected"
                  ...
                  child: Column(
                    ...
                    Visibility(
                      ...
                      children: [
                        ...
                        Text(
                          "Your kyc is Rejected due to following Reasons.",textAlign: TextAlign.center,
                          style: TextStyle(
                        ...
                        Text(
                          widget.kyc_msg==null?"abc":widget.kyc_msg,textAlign: TextAlign.center,
                          style: TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 14,
                              color:day==false?Colors.white:Colors.black),
                      ...
                      new TextFormField(
                        ...
                        decoration: new InputDecoration(
                          ...
                          labelStyle: TextStyle(color:day==false?Colors.white54:Colors.black54 ),
                      ...
                      Text(
                        "Document Type",
                        style:
                            TextStyle(fontSize: 12.0, color: day==false?Colors.white:Colors.black),
                      ),
                      Container(
                        child: DropdownButton<Doc>(
                          ...
                          iconDisabledColor: day==false?Colors.white54:Colors.black54,
                          isExpanded: true,
                          style: TextStyle(color: day==false?Colors.white:Colors.black),
                          hint: Text(
                            "Select Document Type",
                            style:
                                TextStyle(fontSize: 14.0,color:day==false?Colors.white54:Colors.black45),
                          ),
                          value: _selectDoc,
                              ...
                              child: Row(
                                children: <Widget>[
                                  Text(
                                    user.name,
                                    style: TextStyle(
                                      fontSize: 14.0,color:day==false?Colors.white:Colors.black,
                                    ),
                                  ),
                                ],
                              ),
                                  ...
                                  showGeneralDialog(
                                          transitionBuilder:
                                            ...
                                            return Transform.scale(
                                              ...
                                              child: Opacity(
                                                opacity: a1.value,
                                                child: AttachmentAddDialogBox("Front"),
                                              ),
                                            );
                                          },
                                          transitionDuration:
                                          ...
                                          pageBuilder: (context, animation1,
                                              animation2) {})
                                      .then((value) => getFrontDisplayImage());
                                },
                                child: Container(
                                  ...
                                  height: 100,
                                  width: 150,
                                  child: imageFront == null ?Icon(
                                    Icons.image_outlined,
                                   color:day==false?Colors.white:Colors.black,
                                    size: 100,
                                  ):Container( height: 100,width: 150,child: Image.file(imageFront),)
                                ),
                              )
                            ],
                          ),
                                  ...
                                  showGeneralDialog(
                                      transitionBuilder:
                                        ...
                                        return Transform.scale(
                                          ...
                                          child: Opacity(
                                            opacity: a1.value,
                                            child: AttachmentAddDialogBox("Back"),
                                          ),
                                        );
                                      },
                                      transitionDuration:
                                      ...
                                      pageBuilder: (context, animation1,
                                          animation2) {})
                                      .then((value) => getBackDisplayImage());
                                },
                                child:  Container(
                                    decoration: BoxDecoration(
                                        border: Border.all(color: day==false?Colors.white54:Colors.black54)),
                                    height: 100,
                                    width: 150,
                                    child: imageback == null ?Icon(
                                      Icons.image_outlined,
                                     color:day==false?Colors.white:Colors.black,
                                      size: 100,
                                    ):Container( height: 100,width: 150,child: Image.file(imageback),)
                                ),
                              )
                            ],
                          ),
                      ...
                      new TextFormField(
                        ...
                        decoration: new InputDecoration(
                          ...
                          labelText: 'PAN Card',
                          hintStyle: TextStyle(color:day==false?Colors.white54:Colors.black54 ),
                          labelStyle: TextStyle(color:day==false?Colors.white:Colors.black ),
                        ),
                      ),
                      SizedBox(
                        height: 10,
                      ...
                      InkWell(
                          ...
                          showGeneralDialog(
                              transitionBuilder:
                                ...
                                return Transform.scale(
                                  ...
                                  child: Opacity(
                                    opacity: a1.value,
                                    child: AttachmentAddDialogBox("Pan"),
                                  ),
                                );
                              },
                              transitionDuration:
                        ...
                        child: Container(
                            ...
                            height: 100,
                            width: 150,
                            child: imagepancard == null ?Icon(
                              Icons.image_outlined,
                             color:day==false?Colors.white:Colors.black,
                              size: 100,
                            ):Container( height: 100,width: 150,child: Image.file(imagepancard),)
                        ),
                      ),
                      SizedBox(
                        height: 10,
                      ...
                      Container(
                        ...
                        child: ElevatedButton(onPressed: (){
                                                      ...
                                                      if (formState.validate()) {
                                                        ...
                                                        if(imageFront==null){
                                                          ToastShowClass.toastShow(context, "Please Choose the Front Image", Colors.red);
                                                        }else if(imageback==null){
                                                          ToastShowClass.toastShow(context, "Please Choose the Back Image", Colors.red);
                                                        }else if(imagepancard==null){
                                                          ToastShowClass.toastShow(context, "Please Choose the Pan Image", Colors.red);
                                                        }else{
                                                                            setState(() {
                            enable=false;
                          });
                         ...
                         style: ButtonStyle(
                          ...
                          child: enable==true?Text("Save",style: TextStyle(color: Colors.white),):Container(height:15,width:15,child: CircularProgressIndicator(color: Colors.white,)),
                        ),
                      ),
                      SizedBox(
                        height: 10,
            ...
            :Verifiedstatus == "pending"  ?Center(
                child: Container(
                  child: Text(
                    "Your Kyc has been submitted successfully and Pending For Approval.",textAlign: TextAlign.center,
                    style: TextStyle(
                       color:day==false?Colors.white:Colors.black,fontSize: 14),
                  ),
                ),
              ):Center(
    child: Container(
    child: Text(
    "Your Kyc verification is successfully completed.",textAlign: TextAlign.center,
    style: TextStyle(
    color:day==false?Colors.white:Colors.black,fontSize: 14),
    ),
    ),
