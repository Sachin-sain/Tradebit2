...
class _ActivityLogState extends State<ActivityLog> {
 ...
 Getlog();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Activity Log Detail",style: TextStyle(fontFamily: "IBM Plex Sans")),backgroundColor: Color(0xff17394f),),
              backgroundColor:day==false?Colors.black:Colors.white,

      body: loglist.length>0?Column(
              children: [
                Expanded(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                          width: 100,
                                          child: Text("Date:",style: TextStyle(fontSize:16,color:day==false?Colors.white:Colors.black,fontWeight: FontWeight.bold),)),
                                      SizedBox(width: 30,),
                                      Text(DateFormat("dd-MMM-yyyy hh:mm:ss").format( DateTime.parse(loglist[index]['created_at'].toString()).toLocal()).toString(),style: TextStyle(fontSize:16,color:day==false?Colors.white:Colors.black,)),
                                    ],
                                  ),
                                  Row(
                                    // mainAxisAlignment: MainAxisAlignment.,
                                    ...
                                    children: [
                                      Container(
                                          width: 100,
                                          child: Text("IP:",style: TextStyle(fontSize:16,color:day==false?Colors.white:Colors.black,fontWeight: FontWeight.bold),)),
                                      SizedBox(width: 30,),
                                      Container(
                                          width: 150,
                                          child: Text(loglist[index]['ip'].toString(),style: TextStyle(fontSize:16,color:day==false?Colors.white:Colors.black,))),
                                    ],
                                  ),
                                  Row(
                                    // mainAxisAlignment: MainAxisAlignment.,
                                    ...
                                    children: [
                                      Container(
                                          width: 100,
                                          child: Text("Activity:",style: TextStyle(fontSize:16,color:day==false?Colors.white:Colors.black,fontWeight: FontWeight.bold),)),
                                      SizedBox(width: 30,),
                                      Text(loglist[index]['message'].toString(),style: TextStyle(fontSize:16,color:Colors.blueAccent,fontWeight: FontWeight.bold)),
                                    ],
                                  ),
             ...
             Container(child: Text("Activity log is empty",
