...
class _TwoFactorAuthState extends State<TwoFactorAuth> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor:Color(0xff17394f),title: Text("2F Authentication Setting",style: TextStyle(fontFamily: "IBM Plex Sans")),),
      body: Padding(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Text("Email Verification",style: TextStyle(color:day==false?Colors.white: Colors.black),),
                            Padding(
                        ...
                        Theme(
                          data: Theme.of(context).copyWith(
                              unselectedWidgetColor:day==false?Colors.white: Colors.black,
                          ),
                          child: Radio(
                            value: 1,
                            groupValue: _radioSelected,
                            activeColor:day==false?Colors.white: Colors.black,
                            onChanged: (value) {
                              setState(() {
                    ...
                    Divider(color:day==false?Colors.white: Colors.black,),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text("None",style: TextStyle(color:day==false?Colors.white: Colors.black)),
                            ),
                            Padding(
                              padding: const EdgeInsets.all(5.0),
                              child: Container(child: Padding(
                                padding: const EdgeInsets.all(5.0),
                                child: Text("Non Recommended",style: TextStyle(color: Colors.white)),
