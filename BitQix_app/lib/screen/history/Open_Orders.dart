...
class _RemainingopenOrdersState extends State<RemainingopenOrders> {
  ...
  getremainingorder(int pagenumber) async {
    ...
    print('open ordet ======================>>>>   ${response.body}');

    var data = json.decode(response.body);
    print('open ordet ======================>>>>   $data');
  ...
  //       APIClasses.EditOrder + orderid, paramDic, "Put");
  //   var data = json.decode(response.body);
  //   if (response.statusCode == 200) {
  //     setState(() {
  //       ToastShowClass.toastShow(context, data['message'], colorStyle.primaryColor);
  //       getremainingorder(pagenumber);
  //
                        ...
                        child: isProgress
                            ? ListView.builder(
                                ...
                                itemBuilder: (BuildContext ctx, int i) {
                                  // jsonDecode(remainingorder[i]['extra']);
                                  return Padding(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                //     child: Text(
                                                //       remainingorder[i]['commission'] ==
                                                //           null
                                                //           ? ""
                                                //           : remainingorder[i]['commission'] +"%",
                                                //       style: TextStyle(
                                                //           color: remainingorder[i]['order_type']=="sell"?Colors.red:Colors.green,
                                                //           fontFamily: "IBM Plex Sans",
                                                //           fontSize: 12.0),
                                                //       textAlign:
                                                //       TextAlign.center,
