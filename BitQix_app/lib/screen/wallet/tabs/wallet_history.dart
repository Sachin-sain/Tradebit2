...
dataload=true;
  ...
  Future<void> DepositHistory() async {
    ...
    var response = await LBMAPIMainClass(APIClasses.Wallethistory, paramDic, "Get");
...
setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text("Withdrawl History",style: TextStyle(fontFamily: "IBM Plex Sans")), backgroundColor: Color(0xff17394f)),backgroundColor:day==false? Colors.black:Colors.white,
          ...
          children: [
            Row(
              ...
              children: [
                Row(
                  children: [
                    Text("Symbol : ",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: day==false? Colors.white:Colors.black)),
                    Text(History_data[index]["currency"].toString(),style: TextStyle(fontSize: 10,color: day==false? Colors.white:Colors.black)),
                  ],
                ),
                // InkWell(
                //   onTap: (){
                ...
                Row(
                  children: [
                    ...
                    Text(History_data[index]["amount"].toString(),style: TextStyle(fontSize: 10,color: day==false? Colors.white:Colors.black)),
                  ],
                ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(History_data[index]["status"].toString(),style: TextStyle(fontSize: 10,color: day==false? Colors.white:Colors.black)),
                  ],
                ),
                Row(
                  children: [
