        ...
        body: Column(
          children: [
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      color: day == false ? Color(0xff333b46) : Colors.black26,
                      child: Text(
                        'Deposit History',
                        softWrap: true,
                        style: TextStyle(
            ...
            Row(
              ...
              children: [
                Text(
                  "Hide low balance wallets ",
                  style: TextStyle(
                      color: day == false ? Colors.white : Color(0xff17394f)),
                ),
                Switch(
                    activeColor: Color(0xff143047),
                    //inactiveThumbcolor: day==false?Colors.white:Colors.black,
                    trackColor: MaterialStateProperty.all(
                        Color(0xff143040).withOpacity(0.5)),
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        if (switchVal == false) {
                          ...
                          allCurrenciesData.addAll(savedothercryptodata);
                          print(
                              allCurrenciesData.length.toString() + "    lmns");
                        } else {
                          allCurrenciesData.clear();
                          allCurrenciesData.addAll(nonEmptyList);
                          print(
                              allCurrenciesData.length.toString() + "    lmn");
                        }
                      });
                    })
              ],
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        //           border:
        //           Border.all(color: colorStyle.grayBackground, width: 3.0),
        //           color: colorStyle.grayBackground),
        //       child: InkWell(
        //         onTap: () {
        //           Navigator.push(
        //               context, EnterExitRoute(enterPage: TransactionOrders()));
        //         },
        //         child: Padding(
